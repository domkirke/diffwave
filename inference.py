...
def main(args):
  if args.spectrogram_path:
    ...
    spectrogram = None
  params = OmegaConf.load(args.config or f'{args.model_dir}/config.yaml')
  audio, sr = predict(spectrogram, model_dir=args.model_dir, fast_sampling=args.fast, params=params)
